...
const Kenyan = () => {
  ...
  // Filter music data for songs in the "kenyan" genre
  const kenyanMusic = musicData.filter(song => song.genre === 'kenyan');
  ...
  return (
    <Box p="4">
      <Heading mb="4">Kenyan Music</Heading>
      <Flex direction="column" gap="4">
        {kenyanMusic.map(song => (
