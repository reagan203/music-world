...
import { Box, Heading, Text, Button, Flex, Slider, SliderTrack, SliderFilledTrack, SliderThumb, IconButton } from '@chakra-ui/react';
...
const Reggae = () => {
  ...
  // Filter music data for songs in the "reggae" genre
  const reggaeMusic = musicData.filter(song => song.genre === 'reggae');
  ...
  return (
    <Box p="4">
      <Heading mb="4">Reggae Music</Heading>
      <Flex direction="column" gap="4">
        {reggaeMusic.map(song => (
